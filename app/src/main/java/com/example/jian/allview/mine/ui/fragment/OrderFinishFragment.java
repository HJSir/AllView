 ...
 */
public class OrderFinishFragment extends  BaseFragment<OrderPresenter> implements IOrderView {
...
//        mListView.setAdapter(new OrderWaitAdapter(getActivity(),mList));
    ...
    public void initView(View rootView) {
        ...
        mListView= (ListView) rootView.findViewById(R.id.lv_order_finish);
    }
