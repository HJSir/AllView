...
import com.example.lenovo.mainui.*;
 ...
 */
public class SelectMenuViewHotel extends LinearLayout {
    ...
    public SelectMenuViewHotel(Context context) {
        super(context);
    ...
    public SelectMenuViewHotel(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        this.mRootView = this;
        init();
    ...
    protected void onFinishInflate() {
        ...
        View.inflate(mContext, R.layout.layout_search_menuhotel, this);

        mSubjectText = (TextView) findViewById(R.id.subject2);
        mSubjectArrowImage = (ImageView) findViewById(R.id.img_sub2);

        mSortText = (TextView) findViewById(R.id.comprehensive_sorting2);
        mSortArrowImage = (ImageView) findViewById(R.id.img_cs2);

        mSelectText = (TextView) findViewById(R.id.tv_select2);
        mSelectArrowImage = (ImageView) findViewById(R.id.img_sc2);

        mContentLayout = (RelativeLayout) findViewById(R.id.rl_content2);
        ...
        mSubjectView = findViewById(R.id.ll_subject2);
        mSortView = findViewById(R.id.ll_sort2);
        mSelectView = findViewById(R.id.ll_select2);
